...
#          r"###((.|\n)*)" # grp7 parametrages 
#          r"###((.|\n)*)" # grp9 scripts 
#          r"## ((.|\n)*)" # grp11 business modules
#          r"## ((.|\n)*)" # grp13 description originale

# featureStr = r"##(.*)\n+" grp1 title en 
#              r"##(.*)\n+" grp2 title fr
#              r"###((.|\n)*)" grp3 parametrages 
#              r"###((.|\n)*)" grp5 scripts
#              r"## ((.|\n)*)" grp7 business modules
#              r"## ((.|\n)*)" grp9 description originale

# pattern if bug
bugStr = (r"## \[title_en\](.*)"  # grp1 = title_en
          r"## \[title_fr\](.*)"  # grp3 = title_fr
...
featureStr = (r"## \[title_en\]((.|\n)*)"  # grp1 = title_en
              r"## \[title_fr\]((.|\n)*)"  # grp3 = title_fr
              r"### \[parametrage_fr\]((.|\n)*)"  # grp5 = parametrages_fr
              r"### \[scripts_fr\]((.|\n)*)"  # grp7 = scripts_fr
              r"## \[business_modules\]((.|\n)*)"  # grp9 = business modules
              r"## \[original_description\]((.|\n)*$)")  # grp11 = original description
